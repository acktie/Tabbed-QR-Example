...
// in simulator we redefine to format for TabbedQRExample Developer console
...
{\
	NSString * exceptionName = [@"org.tabbedqrexample." stringByAppendingString:NSStringFromClass([self class])];\
...
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.tabbedqrexample";\
	NSString * message = [NSString stringWithFormat:@"%@. %@ %@",reason,(subreason!=nil?subreason:@""),(location!=nil?location:@"")];\
	TiExceptionThrowWithNameAndReason(exceptionName,message);\
}\
...
enum {
	UITabbedQRExampleNativeItemNone = -1, 
	UITabbedQRExampleNativeItemSpinner = -2,
	UITabbedQRExampleNativeItemProgressBar = -3,
	
	UITabbedQRExampleNativeItemSlider = -4,
	UITabbedQRExampleNativeItemSwitch = -5,
	UITabbedQRExampleNativeItemMultiButton = -6,
	UITabbedQRExampleNativeItemSegmented = -7,
	
	UITabbedQRExampleNativeItemTextView = -8,
	UITabbedQRExampleNativeItemTextField = -9,
	UITabbedQRExampleNativeItemSearchBar = -10,
	
	UITabbedQRExampleNativeItemPicker = -11,
	UITabbedQRExampleNativeItemDatePicker = -12,
	
	UITabbedQRExampleNativeItemInfoLight = -13,
	UITabbedQRExampleNativeItemInfoDark = -14,
	
	UITabbedQRExampleNativeItemDisclosure = -15,
	
	UITabbedQRExampleNativeItemContactAdd = -16
};
...
/*
 *	TiThreadPerformOnMainThread should replace all TabbedQRExample instances of

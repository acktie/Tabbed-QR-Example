 ...
 * Copyright (c) 2009-2011 by TabbedQRExample, Inc. All Rights Reserved.
...
//@interface TabbedQRExampleObject : NSObject
//@end

@interface TabbedQRExampleObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[TabbedQRExampleObject class]])
		{
			for (NSString *key in [[(TabbedQRExampleObject*)o modules] allKeys])
			{

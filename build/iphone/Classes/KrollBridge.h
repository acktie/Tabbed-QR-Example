...
@interface TabbedQRExampleObject : KrollCoverageObject {
#else
@interface TabbedQRExampleObject : KrollObject {
#endif
@private
...
extern NSString * TabbedQRExample$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	TabbedQRExampleObject *_tabbedqrexample;
	BOOL shutdown;
